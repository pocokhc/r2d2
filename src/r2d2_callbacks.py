...
from .r2d2 import R2D2Callback, R2D2
from .common import LoggerType


class SaveManager(R2D2Callback):
    def __init__(self,
            save_dirpath,
            is_load=False,
            save_overwrite=True,
    ...
    def on_r2d2_actor_end(self, index, actor):
        dirname = os.path.join(self.save_dirpath, "last")
        os.makedirs(dirname, exist_ok=True)
...
class Logger2Stage(R2D2Callback):
    def __init__(self,
